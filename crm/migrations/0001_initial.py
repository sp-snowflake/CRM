# Generated by Django 3.2.4 on 2021-06-15 07:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consult_cources', models.ManyToManyField(to='crm.Course', verbose_name='咨询课程')),
            ],
        ),
        migrations.CreateModel(
            name='Role',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.TextField(blank=True, max_length=1024, null=True, verbose_name='成绩备注')),
                ('date', models.DateTimeField(auto_now_add=True)),
