...
from django.contrib.auth.models import User     # Django自带的用户认证

# Create your models here.

class UserProfile(models.Model):
    """用户信息表"""
    user = models.OneToOneField(User,on_delete=models.CASCADE)  # 这样就能使用导入的认证
    name = models.CharField(max_length=64,verbose_name="姓名")
    role = models.ManyToManyField("Role",blank=True,null=True)  # 角色

    def __str__(self):  # 如果是2.7版本，这里写__unicode__
        return self.name
...
class CustomerInfo(models.Model):
    ...
    contact_type_choices = ((0,'qq'),(1,'微信'),(2,'手机'))     # 必须留一个联系方式
    contact_type = models.SmallIntegerField(choices=contact_type_choices,default=0) # 默认是QQ
    contact = models.CharField(max_length=64,unique=True)   # 联合唯一
    source_choice = ((0,'QQ群'),(1,'51CTO'),(2,'百度推广'),(3,'知乎'),(4,'转介绍'),(5,'其它'))  # 转介绍需要有介绍人的信息
    ...
    consult_cources = models.ManyToManyField("Course",verbose_name="咨询课程")
    consult_content = models.TextField(verbose_name="咨询内容")
    status_choices = ((0,'未报名'),(1,'已报名'),(2,'已退学'))
    status = models.SmallIntegerField(choices=status_choices)
    consultant = models.ForeignKey("UserProfile",verbose_name="课程顾问",on_delete=models.CASCADE)
    date = models.DateField(auto_now_add=True)  # 创建了自动添加
...
class ClassList(models.Model):
    ...
    class_type_choice = ((0,'脱产'),(1,'周末'),(2,'网络班'))
    ...
    class Meta:
        unique_together = ('branch','class_type','course','semester')    # 联合唯一
...
class StudyRecord(models.Model):
    ...
    score_choices = ((100,"A+"),(90,"A"),(85,"B+"),(80,"B"),(75,"B-"),(70,"C+"),(60,"C"),(40,"C-"),(-50,"D"),
                     (0,"N/A"),   # 意思是 not available ，不可得的意思，特殊情况的学员
                     (-100,"Copy"),
                     )
    score = models.SmallIntegerField(choices=score_choices,default=0)
    show_choice = ((0,"缺勤"),(1,"已签到"),(2,"迟到"),(3,"早退"),)
    show_status = models.SmallIntegerField(choices=show_choice,default=1)
...
class Menus(models.Model):
    ...
    url_type = models.SmallIntegerField(choices=url_type_choice,default=0)
